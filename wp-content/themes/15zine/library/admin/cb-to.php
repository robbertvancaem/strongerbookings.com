...
function cb_to() {
  ...
  $custom_settings = array(
    ...
    'sections'        => array(
      ...
      array(
        'id'          => 'ot_blogstyles',
        'title'       => '<i class="fa fa-th-large"></i> Blog Styles'
      ),
      array(
        'id'          => 'ot_advertising',
    ...
    array(
      ...
      array(
        'id'          => 'cb_sw_menu',
        'label'       => 'Sticky Menu Width',
        'desc'        => 'Width of main navigation menu when it becomes sticky.',
        'std'         => '',
        'section'     => 'ot_sitewidth',
        'type'        => 'select',
        'rows'        => '',
    ...
    array(
      ...
      array(
        'id'          => 'cb_mb_lang',
        'label'       => 'MultiByte Language',
        'desc'        => 'Some languages use multibytes (Such as Chinese). Enable this if your site has visible bugs (question mark icons) in the excerpts.',
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'ot_extras',
        'rows'        => '',
